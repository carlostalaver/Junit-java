...
public class RewardByGiftServiceTest {
    ...
    void correctProductID() {
        ...
        assertEquals(
                4,
                reward.getGiftProductId(),
                () -> { // esta funcion solo se ejecuta se la assert FALLA
    ...
    void rewardApplied() {
        ...
        /*
         * assertAll permite que se ejecuten todas las expresiones lambda,  incluso si la primera falla intentara
         * ejecutar el resto
         * 
         * */
        assertAll("Reward info errors",
    ...
    void exceptionThrownWhenInvalidProductID() {
        ...
        // assertThrows falla si no lanza una excepcion o la lanza pero del tipo incorrecto
        /*assertThrows(RuntimeException.class, () -> {
            reward.setGiftProductId(productId);
        });*/
        
        // Capturando la excepcion lanzada para comprobaciones adicionales
    ...
    void timeoutNotExceeded() {
        ...
        RewardInformation info = assertTimeout/*Preemptively*/( // si usara assertTimeoutPreemptively se interrumpiria la ejecuion de a prueba inmediatamente despues de que el tiempo sea excedido
                Duration.ofMillis(4), // El Duration es proporcionado por asserTimeout 
                () ->
                        reward.applyReward(
