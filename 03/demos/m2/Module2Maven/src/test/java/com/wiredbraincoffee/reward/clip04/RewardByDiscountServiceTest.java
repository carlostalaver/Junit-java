...
public class RewardByDiscountServiceTest {
    ...
    @Nested
    class SmallOrder {
    	/* notar que es una clase INTERNA NO ESTATIICA
    	 * @BeforeEach y @AfterEach funcionan dentro de la pueba anidada sin embargo 
    	 * @BeforeAll y @AfterAll NO FUNCIONAN DE MANERA PREDETERMINADA	PORQUE NO se permiten
    	 * metodos estaticos en clases INTERNAS, si embargo esta restriccion se puede eludir configurando
    	 * un modo de ciclo de vida PER_CLASS en la clase anidada
    	 * */
        ...
        class ZeroPoints { // Tengo una clase interna DENTRO de otra clase interna
